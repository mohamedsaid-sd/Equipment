...
// curl_close($curl);
    ...
    <h3 for="textAreaRemark"> مواصفات الموقع: </h3>
      ...
      <div class="row">
        <div class="col-md-4 form-group">
        موقع العمل <br/>
          <input type="text" id="state" name="state" class="form-control" placeholder="الولاية" required>
        </div>
        <div class="col-md-4 form-group mt-3 mt-md-0">
          <br/>
        ...
        <div class="form-group col-md-4">
          <br/>
       <input type="text" class="form-control" name="distance_from_nearest" id="distance_from_nearest" placeholder=" المسافة من اقرب سوق " required>
          </div>
      </div>
      ...
      <div class="row">
        ...
        نوع العمل <br/>
         ...
         <div class="form-group col-md-4">
          ...
          <label> <b>JOB SITE READINESS  : ترجم</b> </label> 
       ...
       <div class="row">
        ...
        <div class="form-group col-md-4">
         ...
         <div class="form-group col-md-4">
          ...
          <div class="form-group col-md-4">
           <label> المومبروسر </label> راجع الحروف
           <div class="d-flex flex-row justify-content-between align-items-center">
          ...
          <div class="row">
            ...
            <input type="text" id="nearest_paved_road" name="nearest_paved_road" class="form-control" placeholder="ادخل اقرب طريق معبد" required/>
              ...
              <div class="row">
                ...
                <div class="col-md-4 form-group">
                  <input type="text" name="customer_name" class="form-control" placeholder="  ادخل الاسم " required>
                </div>
                <div class="col-md-4 form-group mt-3 mt-md-0">
                  <input type="email" class="form-control" name="customer_email" placeholder=" ادخل البريد الالكتروني " required>
                </div>

                <div class="col-md-4 form-group mt-3 mt-md-0">
                    <input type="text" class="form-control" name="customer_job_title" placeholder=" ادخل المسمى الوظيفي " required>
                  </div>
              ...
              <div class="col-md-4 form-group mt-3 mt-md-0">
              <lable> هل عملت معنا من قبل </lable> 
