...
if(isset($_SESSION['cart'])){
  ...
  <center>
  	...
  	<div class="form-group col-md-6">
  	<label></label>
  	<input type="phone" name="phone" class="form-control" placeholder="Mobile no." required/>
  	</div>
  	...
  	<thead>
  		<tr style="background-color: orange">
  			<th style="text-align: center;color: #000;">  Item / Service </th>
  			<th style="text-align: center;color: #000;"> Price </th>
  		</tr>
  	</thead>
  	<tbody>
  	<?php
    ...
    elseif ($key % 3 == 2) 
  	...
  	?>
  	<td style="text-align: center;"> <b style="color: #000;"> Total </b> </td>
  	<td style="text-align: center;color: #000;"> <?php echo $sum ." SDG " ; ?> </td>
  	</tbody>
  	</table>
  	<br/><br/>
  	<input type="submit" name="confirm" class="btn btn-success" value="Confirm Request">

  </center>	
  </form><br/>
  <a href="store.php?exit=0" class="btn btn-danger"> Emptying the Cart </a>
  <?php
	}// end session check
	else{
		echo "<center> <h2> Empty Cart </h2> </center>";
	}
?>
  </div>
  </div>
