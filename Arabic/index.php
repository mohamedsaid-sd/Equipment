...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" style="background-color: #00000077;padding: 10px;color: #fff;">
      <h1 style="color: #fff;">مرحبا بكم في منصة إكوبيشن الإلكترونية</h1>
      <h2 style="color: #eee;">تعمل إكوبيشن علي تنفيذ مشاريع المقاولات المدنية والبنى التحتية ومقاولات التعدين، مسلحة في ذلك بأحدث الآليات والمعدات وبفريق من المهندسين والفنيين الأكفاء المهرة، لتنفيذ المشاريع بأعلى جودة مطلوبة</h2>
...
محمد إدريس علي 
            ...
            <li>
            تحقيق اعلى انتاجيه ممكنه
            </li>
          
            <li>
            تحقيق استقرار وإستمرار العمل  
            </li>                
            
            <li>          
            المساهمة في تطوير مجال الخدمات
            </li>                  
               
            <li>
            خلق بيئة إنسانية وبيئة منتجة وصحية ومستدامه
            </li>

            <li>
            توفير كافة الطلبات الإنتاجية للعملاء
            </li>
...
لذلك قامت EQUIPATION بفتح هذا القسم وكان شعارها الأساسي في ذلك هو سرعة الإستجابة وجودة الخدمة مع تعزيز مفهوم الوقاية قبل العلاج ، لذلك حاولنا أن نجمعكم جميع المختصين والمنتشرين في كافة ربوع بلادنا للإستفادة المتبادلة  ما بينا أعضاء هذا القطاع.
ويسرنا في هذا المكان أن نقرب المسافات ما بين مقدمي الخدمات من شركات وأصحاب أعمال وحتى الأفراد وراواد الأعمال لهم مكان متاح معنا والذين يتمركز عملهم في خدمات الصيانة والإسبير والفحص وكل ما يتعلق بتلك النشاطات، والتي يستفيد منها بشكل أساسي كل شركات المقاولات والإنتاج وملاك الآليات والمعدات في كل بقاع السودان.
وهدفنا هو أن نسهل وصولكم لبعض، وتعزيز مفهوم المنافسة في تجويد الخدمات وتبادل الخبرات وتوفير الأوقات في إيجاد الخيار الأفضل والأسرع والأقرب.

فمرحبا بكم بيننا .. وأعاننا وإياكم على تحقيق غاياتنا وأهدافنا من هذا القسم.</p>
            </div>
          </div>
          ...
          <div class="col-lg-12 col-md-12 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <p> تقدر EQUIPATION مسألة الوقت في كل خطواتها، وتعرف أن مسألة الوقت هي القيمة الفارقة في النتائج النهائية، ولأهمية المسألة ربطت جميع عملياتها بالوقت وأصبح هو العامل الأساسي في قياس جودة الخدمة من عدمها.
ولأن الترحيل هاجس كبير لكل الشركات والملاك والمنتجين، فإن EQUIPATION  لم تتركه للحظ أو تهمل هذا الجانب وإستفادت من شراكتها مع فرسان الطريق الذين لهم دور كبير في تحقيق النجاح وإستكمال الصورة الكاملة.
ولتصل آليتك في الوقت المثالي يجب أن تراعي تناسب الناقل مع حجم ووزن الآلية المنقولة، وأيضا جاهزية الناقل من الناحية الفنية وقربه منك ومعرفته بالمناطق والطرق وموثوقيته.
لذلك فتحنا هذه المساحة لكي نجمع فيها جميع أصحاب اللوابد والسطحات والسحابات في مكان واحد لنسهل لكم إختيار الأنسب والأقرب والأوفر ونعزز قيمة الأوقات لدى مقدمي الخدمة وطالبيها، وسنسهل تتبع عملية النقل مع شركائنا لحظة بلحظة.</p>
            </div>
          </div>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy;  <strong><span> شركة إكوبيشن </span>2023</strong>. كل الحقوق محفوظة
        </div>
        <div class="credits">
